namespace OpenAPI4Net.Examples
{
    ...
    /// 自由项
    /// </summary>
    public class Freearch
    {
        private static Log _logger = new Log();
        private const string SOURCE = ""; //"OpenAPI4Net.Examples.Freearch";
        ...
        public static void Test()
        {
            try
            {
                FreearchApi api = new FreearchApi();

                #region 获取单个资源
                _logger.Info("**** get ****");

                BusinessObject bo = api.Get("cFree9");
                ...
                parameters.Add("field_name", "cFree7");
