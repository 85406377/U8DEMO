namespace OpenAPI4Net.Examples
{
    ...
    public class Inventory
    {
        ...
        private const string SOURCE = ""; //"OpenAPI4Net.Examples.Inventory";
        ...
        public static void Test()
        {
            try
            {
                ...
                BusinessObject bo = api.Get("0501");
                ...
                parameters.Add("code_begin", "0501");
                parameters.Add("code_end", "0520");
                ...
                #region 新增
                _logger.Info("**** add ****");
                String data = "{\"inventory\":{\"code\":\"0392\",\"name\":\"0392n\",\"sort_code\":\"03\",\"main_measure\":\"0101\",\"entry\":[{\"invcode\":\"0392\"}]}}";
                String biz_id = "0392";
                bo = api.Add(data, biz_id);
