namespace OpenAPI4Net.Examples
{
    ...
    /// 交易分类
    /// </summary>
    public class Payunitclass
    {
        private static Log _logger = new Log();
        private const string SOURCE = ""; //"OpenAPI4Net.Examples.Payunitclass";
        ...
        public static void Test()
        {
            try
            {
                PayunitclassApi api = new PayunitclassApi();
