namespace OpenAPI4Net.Examples
{
    ...
    public class Salaryitem
    {
        ...
        private const string SOURCE = ""; //"OpenAPI4Net.Examples.Salaryitem";
        ...
        public static void Test()
        {
            try
            {
                SalaryitemApi api = new SalaryitemApi();

                #region 获取单个资源
                _logger.Info("**** get ****");

                BusinessObject bo = api.Get("8");
                ...
                parameters.Add("code_begin", "2");
                parameters.Add("code_end", "8");
