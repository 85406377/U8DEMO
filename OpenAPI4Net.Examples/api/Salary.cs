namespace OpenAPI4Net.Examples
{
    ...
    public class Salary
    {
        ...
        private const string SOURCE = ""; //"OpenAPI4Net.Examples.Salary";
        ...
        public static void Test()
        {
            try
            {
                SalaryApi api = new SalaryApi();

                #region 获取单个资源
                _logger.Info("**** get ****");

                BusinessObject bo = api.Get("00002");
                ...
                parameters.Add("code_begin", "00002");
                parameters.Add("code_end", "00006");
