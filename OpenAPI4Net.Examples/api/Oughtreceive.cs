namespace OpenAPI4Net.Examples
{
    ...
    /// 应收单
    /// </summary>
    public class Oughtreceive
    {
        private static Log _logger = new Log();
        private const string SOURCE = ""; //"OpenAPI4Net.Examples.Oughtreceive";
        ...
        public static void Test()
        {
            try
            {
                OughtreceiveApi api = new OughtreceiveApi();

                #region 获取单个资源
                _logger.Info("**** get ****");
                BusinessObject bo = api.Get("0000000011");
                ...
                parameters.Add("cust_vendor_code", "0902");
                ...
                String body = "{\"oughtreceive\":{\"cust_vendor_code\":\"00000006\",\"amount\":\"39000\",\"operator\":\"demo\",\"entry\":[{\"cust_vendor_code\":\"00000006\",\"currency_name\":\"港币\",\"currency_rate\":\"10\",\"natamount\":\"30000\",\"amount\":\"3000\"},{\"cust_vendor_code\":\"00000006\",\"amount\":\"9000\"}]}}";
