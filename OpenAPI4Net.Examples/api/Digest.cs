namespace OpenAPI4Net.Examples
{
    ...
    public class Digest
    {
        ...
        private const string SOURCE = ""; //"OpenAPI4Net.Examples.Digest";
        ...
        public static void Test()
        {
            try
            {
                DigestApi api = new DigestApi();

                #region 获取单个资源
                _logger.Info("**** get ****");

                BusinessObject bo = api.Get("234");
                ...
                parameters.Add("code_begin", "11");
                parameters.Add("code_end", "33");
