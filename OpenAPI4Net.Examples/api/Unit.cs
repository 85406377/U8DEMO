namespace OpenAPI4Net.Examples
{
    ...
    public class Unit
    {
        ...
        private const string SOURCE = ""; //"OpenAPI4Net.Examples.Unit";
        ...
        public static void Test()
        {
            try
            {
                UnitApi api = new UnitApi();

                #region 获取单个资源
                _logger.Info("**** get ****");

                BusinessObject bo = api.Get("0102");
                ...
                parameters.Add("code_begin", "0102");
                parameters.Add("code_end", "0202");
