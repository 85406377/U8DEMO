namespace OpenAPI4Net.Examples
{
    ...
    public class Inventoryclass
    {
        ...
        private const string SOURCE = ""; //"OpenAPI4Net.Examples.Inventoryclass";
        ...
        public static void Test()
        {
            try
            {
                InventoryclassApi api = new InventoryclassApi();

                #region 获取单个资源
                _logger.Info("**** get ****");

                BusinessObject bo = api.Get("03");
